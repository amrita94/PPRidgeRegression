...
class LabEncDataType1(object):
    def __init__(self, hidden_message, enc_mask):
    ...
    def __add__(self, other):
        ...
        if isinstance(other, LabEncDataType1):
            return LabEncDataType1(self.hm + other.hm, self.enc_mask + other.enc_mask)
        elif isinstance(other, int):
            return LabEncDataType1(self.hm + other, self.enc_mask)
...
def localGen(mpk):
    ...
    seed = random.randrange(mpk.n) - mpk.max_int
